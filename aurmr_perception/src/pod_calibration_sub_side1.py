...
DATA_SAVE_LOCATION = f"/home/aurmr/calibrationdata/{DATE_STRING}/"
...
POD_FACE_C_FROM_MARKER_Y = {'h': 0.18, 'g': 0.095, 'f': 0.115, 'e': 0.165}
...
if __name__ == '__main__':
    ...
    print(bin_DM_coords)
    #
    with open(os.path.join(DATA_SAVE_LOCATION, "calibration_xyz_coords_pod_base_link.pkl"), 'wb') as f:
        pickle.dump(bin_DM_coords_base_link, f)

    with open(os.path.join(DATA_SAVE_LOCATION, 'calibration_xyz_coords_pod.pkl'), 'wb') as f:
    ...
    print(bin_DM_pixel_coords)
    with open(os.path.join(DATA_SAVE_LOCATION, 'calibration_pixel_coords_pod.pkl'), 'wb') as f:
