...
1. Follow all instructions to set up environment, download sample images, etc. from below instructions.
2. If you plan on segmenting bin data rather than tabletop data, download our pre-trained model from here: https://drive.google.com/file/d/1n1_szbx6GfshF3Fe5Yg2bU8Q9bMo6xED/view?usp=sharing and place it in UnseenObjectClustering/data/checkpoints
3. Download any datasets of interest and store in directory UnseenObjectClustering/data/demo

Segmentation.ipynb contains code for segmenting sample images and evaluating network performance, and train_network.ipynb contains code for training a model on a custom dataset.
