...
class GripperActionServer(object):
    ...
    def __init__(self, name, gripper_type):
        ...
        #TODO Write exception here
            ...
            self.input_msg = None #finger_gripper_input
            self.output_msg = None #finger_gripper_output
        ...
        self._as.start()
        self.command_pub = rospy.Publisher("/vacuum_gripper_control/command", self.output_msg, queue_size=5)
        self.status_listener = rospy.Subscriber("/vacuum_gripper_control/status", self.input_msg, queue_size=5,
    ...
    def execute_cb(self, goal: GripperCommandGoal):
        ...
        #         success = False
        #         break
        #     elif self._status.DEVICE_STATUS != 0: # The gripper either detected an obstacle or is finished moving
