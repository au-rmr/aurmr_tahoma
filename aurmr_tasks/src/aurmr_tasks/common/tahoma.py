...
class Tahoma:
    def __init__(self, in_sim=False):
        ...
        if not server_reached:
            print('[TAHOMA] Unable to connect to arm action server. Timeout exceeded. Exiting...')
            rospy.signal_shutdown('[TAHOMA] Unable to connect to arm action server. Timeout exceeded.')
            sys.exit()
